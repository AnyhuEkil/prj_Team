...
function upPressed(){
	if (listCount>1){
		...
		$(menuLocNth).css({background:"grey",color:"white"});	//이동후 위치 색 넣기
	}
}
...
function zPressed(){
	...
	case "whyBcSkillbox4":	//@
		...
		turnEnd();
		break;
	case "whyTopAcomonbox1":	//@
		//whyBcAcomon1();
		//재현: 이자리 주석만 지우고 함수 넣으면됨.(포켓몬 1
		break;
	case "whyTopAcomonbox2":	//@
		//whyBcAcomon2();
		//재현: 이자리 주석만 지우고 함수 넣으면됨.(2
		turnEnd();
		break;
	case "whyTopAcomonbox3":	//@
		//whyBcAcomon3();
		//재현: 이자리 주석만 지우고 함수 넣으면됨.(3
		turnEnd();
		break;
	case "whyTopAcomonbox4":	//@
		//whyBcAcomon4();
		//재현: 이자리 주석만 지우고 함수 넣으면됨.(4
		turnEnd();
		break;
	case "whyTopAcomonbox5":	//@
		//whyBcAcomon5();
		//재현: 이자리 주석만 지우고 함수 넣으면됨.(5
		turnEnd();
		break;
	case "whyTopAcomonbox6":	//@
		//whyBcAcomon6();
...
function yBcListbox(){
	$("#whyMouse").css({display:"none"});  //맵팀 캔버스 끄기
...
function yBcList2(){
	$(".whyBcListbox").css({display:"none"});  //맵팀 캔버스 끄기
	$(".whyTopAcomonbox").css({display:"block"});	//해당 클래스 이름을 변수로 가져올 방법이 있을꺼같음.. 나중에 추가
	menuLocClassFun("whyTopAcomonbox")
	listCount = 1; //리스트 초기값 선언.
}
function yBcList3(){
	$(".whyBcListbox").css({display:"none"});  //맵팀 캔버스 끄기
...
function turnEnd(){
	...
	$(".whyTopAcomonbox").css({display:"none"});
